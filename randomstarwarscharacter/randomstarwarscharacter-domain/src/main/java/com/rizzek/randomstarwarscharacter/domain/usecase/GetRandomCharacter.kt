...
class GetRandomCharacter(
    ...
    suspend operator fun invoke(): StarWarsCharacter {
        // As of creating this app, there are 82 characters in the Star Wars API.
        // In a more sophisticated app, we would want to get the count of characters from the API (and store it locally for performance reasons), but for now, we will just hardcode the number.
